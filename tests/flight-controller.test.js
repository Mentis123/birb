...
// NOTE: the FreeFlightController tests that used to live here were removed when
// that controller was retired — the live game uses BirdFlight (see
// tests/bird-flight.test.js). These remaining tests cover SimpleFlightController
// via the shared flight harness.
